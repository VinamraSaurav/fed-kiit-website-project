...
const Home = () => {
  return (
    <div className="flex h-[64rem] w-[90rem] m-[0] relative">
      ...
      <div
        className="absolute bottom-0  h-[32rem] w-[90.0625rem] z-[-1]"
        style={{
          background:
            "linear-gradient(0deg, #F45725 -356.87%, rgba(244, 87, 37, 0.00) 75.74%)",
        }}
      ></div>
      <Link to="/sign">
        <button
