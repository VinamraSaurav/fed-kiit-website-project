...
const About = () => {
  return (
    <div className="relative w-[90rem] h-[64rem] bg-[#0e100f] flex">
      ...
      <div
        className="left component w-[68.75rem] h-[64rem] z-[-1] "
        style={{
          background:
  ...
  style={{ background: `url(${rectangle}), lightgray 0% 0% / 100px 100px repeat` }}
></div>




<div className="absolute top-[31rem] left-[18.63rem] w-[45.28688rem] h-[29.04525rem] z-[3]">
        
<div className="absolute w-[13.125rem] h-[13.125rem] flex-shrink-0 top-[20rem] left-[25rem] z-[0]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="211"
            height="211"
        ...
        <div
          className="rectangle flex w-[24.19031rem] h-[36.87325rem] transform rotate-[82.071deg] border-[1px] border-[#ffffff50] rounded-[1rem] backdrop-filter backdrop-blur-[21px] z-[3]"
          style={{
            background:
              "linear-gradient(153deg, rgba(255, 255, 255, 0.20) 0%, rgba(255, 255, 255, 0.00) 100%)",
          }}
      ...
      <div
        className="relative w-[68.75rem] h-[64rem] z-[-1] "
        style={{
          background:
            "linear-gradient(180deg, #000 0%, rgba(51, 51, 51, 0.00) 100%)",
        }}
